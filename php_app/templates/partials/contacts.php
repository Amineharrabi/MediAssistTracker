                ...
                <div class="card h-100 shadow-sm border-0">
                    ...
                    <div class="card-footer bg-transparent border-0 text-muted small">
                        <div class="d-flex justify-content-between">
                            <span><i class="fa-solid fa-calendar-days me-1"></i> Added: <?php echo format_date($contact['created_at']); ?></span>
                            <?php if ($contact['updated_at'] != $contact['created_at']): ?>
                                <span><i class="fas fa-pencil-alt me-1"></i> Updated: <?php echo format_date($contact['updated_at']); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
            ...
            html += `
                <div class="col-lg-4 col-md-6 mb-4 contact-card" data-id="${contact.id}">
                    <div class="card h-100 shadow-sm border-0">
                        ...
                        <div class="card-footer bg-transparent border-0 text-muted small">
                            <div class="d-flex justify-content-between">
                                <span><i class="fa-solid fa-calendar-days me-1"></i> Added: ${formatDate(contact.created_at)}</span>
                                ${contact.updated_at !== contact.created_at ? 
                                    `<span><i class="fas fa-pencil-alt me-1"></i> Updated: ${formatDate(contact.updated_at)}</span>` : ''}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    function openEditContactModal(contactId) {
        ...
        fetch(`/api.php?endpoint=contact&id=${contactId}`)
            ...
            .then(contact => {
                ...
                // Update modal title
                document.getElementById('addContactModalLabel').innerHTML = '<i class="fas fa-pencil-alt me-2"></i> Edit Contact';
