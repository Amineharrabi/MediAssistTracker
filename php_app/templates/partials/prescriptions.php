    ...
    <div class="col-12">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <p class="card-text">Store and manage your prescription records securely. <br>
                    reload everytime you add a new prescription
                </p>
            </div>
        </div>
    </div>
                ...
                <div class="card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <?php if (!empty($prescription['image_data'])): ?>
                            <div class="mt-3 text-center">
                                <img src="data:image/jpeg;base64,<?php echo $prescription['image_data']; ?>" class="img-fluid prescription-thumbnail" style="max-height: 150px; object-fit: contain;" alt="Prescription Image">
                                <div class="mt-2">
                    ...
                    <div class="card-footer bg-transparent border-0 text-muted small">
                        <div class="d-flex justify-content-between">
                            <span><i class="fas fa-calendar-alt me-1"></i> Added: <?php echo format_date($prescription['created_at']); ?></span>
                            <?php if ($prescription['updated_at'] != $prescription['created_at']): ?>
                                <span><i class="fas fa-edit me-1"></i> Updated: <?php echo format_date($prescription['updated_at']); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="viewPrescriptionModalLabel">
                    <i class="fas fa-file-prescription me-2"></i> <span id="view-prescription-title"></span>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
...
<div class="card-body">
    ...
    ${prescription.image_data ? `
        <div class="mt-3 text-center">
            <img src="data:image/jpeg;base64,${prescription.image_data}" class="img-fluid prescription-thumbnail" style="max-height: 150px; object-fit: contain;" alt="Prescription Image">
            <div class="mt-2">
...
<div class="card-footer bg-transparent border-0 text-muted small">
    <div class="d-flex justify-content-between">
        <span><i class="fas fa-calendar-alt me-1"></i> Added: ${formatDate(prescription.created_at)}</span>
        ${prescription.updated_at !== prescription.created_at ? 
            `<span><i class="fas fa-edit me-1"></i> Updated: ${formatDate(prescription.updated_at)}</span>` : ''}
    </div>
</div>
</div>
</div>
    ...
    function openEditPrescriptionModal(prescriptionId) {
        ...
        fetch(`/api.php?endpoint=prescription&id=${prescriptionId}`)
            ...
            .then(prescription => {
                ...
                // Update modal title
                document.getElementById('addPrescriptionModalLabel').innerHTML = '<i class="fas fa-edit me-2"></i> Edit Prescription';
