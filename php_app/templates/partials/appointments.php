        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="viewAppointmentModalLabel">
                    <i class="fa-solid fa-calendar-days me-2"></i> <span id="view-appointment-title"></span>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
    ...
    function openEditAppointmentModal(appointmentId) {
        ...
        fetch(`/api.php?endpoint=appointment&id=${appointmentId}`)
            ...
            .then(appointment => {
                ...
                // Update modal title
                document.getElementById('addAppointmentModalLabel').innerHTML = '<i class="fas fa-pencil-alt me-2"></i> Edit Appointment';
